...
// TODO new lib with no common code
...
export async function getConnections (docName) {
...
export async function getOrCreateDoc (docName) {
  ...
  for (let i = 0; i < updates.length; i++) {
    Y.applyUpdate(ydoc, updates[i]) // TODO make sure this is a uint8array (it's b64 now?)
  }
